...
public class UserManager {
        ...
        @Autowired
        public UserManager(UserService userService, HeaderGenerator headerGenerator,
        ...
        @GetMapping("/info")
        public Mono<?> getUserInfo(@AuthenticationPrincipal Jwt jwt) {
                if (jwt == null) {
                        return Mono.error(new TokenErrorOrAccessTimeOut("Token error or access timeout"));
                }
