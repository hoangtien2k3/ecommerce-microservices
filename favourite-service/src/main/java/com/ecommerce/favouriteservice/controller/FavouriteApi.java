...
import com.ecommerce.favouriteservice.dto.response.collection.DtoCollectionResponse;
...
public class FavouriteApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(FavouriteApi.class);
